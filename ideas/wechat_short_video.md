...
用网格图形来表示和分析不同的互联网产品形式，图中坐标轴方向临近两点间的距离作为一个单位社交距离。

1. 社交：user–friends

	![social_network](./wechat_short_video/social_network.jpg)
...
3. 模版开发工具，建立社区性创作平台
	...
	类似为小程序代码开发者提供Wechat devtools以及语言开发规范一样。设计一种 “视频语言” templateLang和对应的开发工具IDE。这是一种脚本化的视频timeline开发方式。微信提供基础性的原生“视频语言”api，开发者基于api对短视频的模版进行开发和创建。建立开源的模版开发社区，IDE提供脚本代码的编写界面和可视化的编辑界面，使专家性的开发者和普通用户都能够进行短视频timeline的模版化创作。
...
4. 自动保存和快速加载
	...
	微信的其他功能对视频号功能的影响需要被考虑到。短视频的浏览和制作发布存在较高的被迫中断可能性，用户有随时退出视频号使用其他微信功能的需求，例如使用聊天通讯、扫码、支付等功能。因此短视频浏览和创作发布的进度以及素材数据需要即时性的快速自动保存和退出，以及重新进入时快速加载。
...
1. 播放与暂停
	...
	抖音：自动播放，单击暂停，循环播放直至滑动到下一个视频。沉浸式视频观看体验
...
1. 先发优势，市场占有率
	...
	分析抖音用户的年龄与城市构成，市场趋于饱和，没有待开发的新细分市场。竞争必然就是抢夺用户。
...
4. 激发创作，良性的环境
	...
	<!--TODO-->
	抖音初期的内容被视为低俗的代表，现在也仍然存在大量内容低俗话的问题。但是不可否认的是，随着抖音平台的快速发展和用户对内容的选择淘汰，已经出现了越来越多的高质量创作者，新的高质量短视频不仅来自专业性的团队也来自家庭式和个人式的内容创作者，这种现象促进着抖音正在向形成一个良性健康的短视频平台稳步发展。
	
	未来抖音可能会发展产生一个雅俗共赏的包容性社区文化，这种社区文化也将会进一步激发用户进行创作，获得创作愉悦和经济收入。
...
> [抖音用户图像分析](https://mm.edrawsoft.cn/template/51323) 
  
> [焦裕佳. 抖音短视频的传播价值分析. Diss. 北京印刷学院, 2019.](http://cdmd.cnki.com.cn/Article/CDMD-10015-1019013584.htm)

> [朱浩. "微信的 10 万+ VS 短视频的 1000 万+ 在平面媒体转型时, 短视频兴起带来的新一波冲击." 城市党报研究 3 (2019): 22.](http://www.cnki.com.cn/Article/CJFDTotal-CSDB201903022.htm) 
